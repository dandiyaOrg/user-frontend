  ...
  return (
    <footer className="bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-32">
          ...
          <div className="lg:col-span-1">
            ...
            {/* <div className="flex space-x-4">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.328-1.297C4.198 14.97 3.708 13.819 3.708 12.522s.49-2.448 1.297-3.328c.88-.807 2.031-1.297 3.328-1.297s2.448.49 3.328 1.297c.807.88 1.297 2.031 1.297 3.328s-.49 2.448-1.297 3.328c-.88.807-2.031 1.297-3.328 1.297zm7.718 0c-1.297 0-2.448-.49-3.328-1.297-.807-.88-1.297-2.031-1.297-3.328s.49-2.448 1.297-3.328c.88-.807 2.031-1.297 3.328-1.297s2.448.49 3.328 1.297c.807.88 1.297 2.031 1.297 3.328s-.49 2.448-1.297 3.328c-.88.807-2.031 1.297-3.328 1.297z"/>
                </svg>
              </a>
